...
export default function CardThree() {
  return (
    <div className="max-w-sm w-full lg:max-w-full lg:flex shadow-xl hover-zoom-icon-container">
      <div className="bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-center leading-normal md:full sm:1/2">
        ...
        <h2 className="text-blue-600 font-bold text-xl mb-2 hover-zoom-icon-container">Can coffee make you a better developer?</h2>
