...
const AnimatedElement = ({ children }) => {
  ...
  return (
    <div ref={ref} className={inView ? "animate__animated animate__backInUp" : ""}>
      {children}
    </div>
  );
};
    ...
    <div className="background-custom">
      <div className="container mx-auto px-4 pt-[200px]">
        <div className="md:flex justify-center hidden">
          <AnimatedElement>
            <div className="h-[150px] w-[1px] bg-secondary opacity-50 animate__animated animate__fadeIn" />
          </AnimatedElement>
        </div>

        <h2 className="text-7xl font-medium text-secondary text-center py-20 animate__animated animate__backInUp">
