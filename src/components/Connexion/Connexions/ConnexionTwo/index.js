...
export default function ConnexionTwo() {
  return (
    <div className="bg-cover relative h-screen-minus-navbar">
      <StaticImage
        src="../../../../images/test/auth/photo2.jpg"  // Remplacez cela par votre chemin d'image réel
      ...
      <div className='flex items-center justify-center absolute inset-0 bg-black bg-opacity-50'>
        <div className='flex items-center justify-center z-10'>
          <div className='container mx-auto px-60 my-auto'>
